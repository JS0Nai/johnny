...
function ResourcesPage() {
  ...
  const [guidelinesRef, guidelinesInView] = useInView({ threshold: 0.2, triggerOnce: true });
    ...
    <div className="min-h-screen bg-slate-900 relative w-full overflow-x-hidden">
      ...
      <style jsx>{`
        ...
        .quantum-particle {
          ...
          border-radius: 50%;
          animation: quantum-float infinite linear;
        ...
        .quantum-line {
          ...
          animation: quantum-line-move infinite linear;
        ...
        .quantum-orbit {
          ...
          border-radius: 50%;
          animation: quantum-orbit-rotate infinite linear;
        }
        ...
        .quantum-grid {
          ...
          animation: quantum-grid-shift 20s infinite linear;
        }
        ...
        .quantum-wave {
          ...
          animation: quantum-wave-flow infinite linear;
        }

        .quantum-wave:nth-child(1) { top: 20%; }
        .quantum-wave:nth-child(2) { top: 40%; }
        .quantum-wave:nth-child(3) { top: 60%; }
        .quantum-wave:nth-child(4) { top: 80%; }
        ...
        @keyframes quantum-orbit-rotate {
          from { transform: rotate(0deg); }
          to { transform: rotate(360deg); }
        }

        @keyframes quantum-grid-shift {
          0% { transform: translate(0, 0); }
          100% { transform: translate(50px, 50px); }
        }

        @keyframes quantum-wave-flow {
          0% { 

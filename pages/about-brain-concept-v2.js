            ...
            <div className="relative inline-block">
              ...
              <div className="relative w-96 h-96 mx-auto">
                ...
                <div className="relative w-full h-full">
                  <CloudflareImage
                    src="brain-tech-creative"
                    alt="Technical and Creative Brain"
                    width={400}
                    height={400}
                    className={`w-full h-full object-contain transition-all duration-500 ${
                      hoveredSide ? 'scale-105' : ''
                    }`}
                  />
                  
                  {/* Clickable Left Half (Technical) */}
                  <div
                    className={`absolute left-0 top-0 w-1/2 h-full cursor-pointer transition-all duration-300 ${
                      hoveredSide === 'left' ? 'bg-blue-400/10' : ''
                    }`}
                  ...
                  >
                    {hoveredSide === 'right' && (
                      <div className="absolute inset-0 bg-gradient-to-l from-pink-400/20 to-transparent animate-pulse"></div>
                    )}
                  </div>

                  {/* Center Line Indicator */}
                  <div className="absolute left-1/2 top-0 w-0.5 h-full bg-gradient-to-b from-transparent via-gray-600/50 to-transparent transform -translate-x-1/2 pointer-events-none"></div>
                </div>

                {/* Glow Effects */}
                {hoveredSide === 'left' && (
                  <div className="absolute inset-0 pointer-events-none">
                    <div className="absolute left-0 top-1/2 w-32 h-32 bg-blue-400 rounded-full filter blur-3xl opacity-30 -translate-y-1/2 -translate-x-1/2"></div>
                  </div>
                )}
                {hoveredSide === 'right' && (
                  <div className="absolute inset-0 pointer-events-none">
                    <div className="absolute right-0 top-1/2 w-32 h-32 bg-pink-400 rounded-full filter blur-3xl opacity-30 -translate-y-1/2 translate-x-1/2"></div>
                  </div>
                )}
              </div>
              ...
              <div className="flex justify-between mt-12 text-lg max-w-md mx-auto">
                ...
                } ${selectedBrainSide === 'left' ? 'text-blue-300' : ''}`}>
                ...
                } ${selectedBrainSide === 'right' ? 'text-pink-300' : ''}`}>
